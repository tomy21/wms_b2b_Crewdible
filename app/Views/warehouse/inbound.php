...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header bg-danger">
            ...
            <button class="btn btn-sm btn-danger" type="button" onclick="location.href=('<?= site_url('/Inbound/index') ?>')"> <i class="fa fa-backward"></i>
                Back</button>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="No PO" name="nopo" id="nopo" value="<?= $nopo ?>" readonly>
                </div>
                <div class="form-group col-md-6">
                    <label for="">Tanggal Inbound</label>
                    <input type="date" class="form-control" placeholder="No Faktur" name="tglfaktur" id="tglfaktur" value="<?= date('Y-m-d') ?>" readonly>
                </div>
                <div class="form-group col-md-6">
                    <label for="">Warehouse</label>
                    <input type="text" class="form-control" placeholder="No Faktur" name="warehouse" id="warehouse" value="<?= user()->warehouse ?>" readonly>
                </div>
            </div>
