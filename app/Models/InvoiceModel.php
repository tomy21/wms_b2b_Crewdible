...
class InvoiceModel extends Model
{
    ...
    {
        return $this->db->table('tbl_invoice')->select('stock_location, Order_id, count(Item_id) as item,sum(quantity) qty, created_at, updated_at')->groupBy('stock_location')->get()->getResult();
    }
}